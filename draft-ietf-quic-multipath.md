...
Note that PATH_BLOCKED frame is informational, as it is not expected to change
the state of the peer. Sending a PATH_BLOCKED frame does not imply a particular action
