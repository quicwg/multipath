...
: A variable-length integer specifying
  the sequence number assigned for this PATH_STANDBY frame. The sequence
...
Path Status sequence number:
: A variable-length integer specifying
  the sequence number assigned for this PATH_AVAILABLE frame. The sequence
  number MUST be monotonically increasing generated by the sender of
...
TBD-03 (experiments use 0xbaba07)                  | PATH_STANDBY        | {{path-standby-frame}}
TBD-04 (experiments use 0xbaba08)                  | PATH_AVAILABLE      | {{path-available-frame}}
